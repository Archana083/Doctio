  ...
  INSPIRO.slider = {
    ...
    inspiroSlider: function () {
      if ($inspiroSlider.length > 0) {
        ...
        var defaultAnimation = "fadeInLeft";
        ...
        $inspiroSlider.each(function () {
          ...
          var inspiroSliderData = elem.flickity({
            ...
            on: {
              ready: function (index) {
                var $captions = elem.find(".slide.is-selected .slide-photo > *");
                slide_dark(elem);
                sliderHeight(elem);
                start_kenburn(elem);
                animate_captions($captions);
          ...
          inspiroSliderData.on("dragStart.flickity", function () {
            var $captions = elem.find(".slide:not(.is-selected) .slide-photo > *");
            hide_captions($captions);
          });
  ...
  INSPIRO.slider = {
    ...
    inspiroSlider: function () {
      if ($inspiroSlider.length > 0) {
        ...
        var defaultAnimation = "fadeInRight";
